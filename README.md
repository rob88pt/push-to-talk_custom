...
- v0.6.0: https://www.youtube.com/watch?v=A6Lyk7w0Lzs
...
| `language` | string | `"auto"` | Transcription language. Options: `auto`, `en`, `es`, `fr`, `de`, `it`, `pt`, `nl`, `ja`, `ko`, `zh`, `ru`, `hi`. Auto-detect if set to `auto`. |
